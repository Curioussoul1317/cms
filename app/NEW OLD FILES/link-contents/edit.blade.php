                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <div class="text-muted mt-1">
                            Link: <span class="fw-semibold">{{ $model->name }}</span> | 
                            Template: <span class="fw-semibold">{{ $template['name'] ?? $linkContent->template_name }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-4" role="alert">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <div class="text-muted small">Editing Template: {{ $template['name'] ?? $linkContent->template_name }}</div>
                                <div class="h4 mb-0 mt-1">
                                    <i class="{{ $template['icon'] ?? 'ti ti-file' }}" style="font-size: 3rem;"></i>    
                                </div>
                            </div>
                            <!-- @if($type == 'link')
                                <a href="{{ route('links.show', $model) }}" class="btn btn-sm btn-primary">
                                    Back to Link
                                </a>
                            @else
                                <a href="{{ route('link-contents.index', ['type' => $type, 'id' => $model->id]) }}" class="btn btn-sm btn-primary">
                                    Back to Contents
                                </a>
                            @endif -->
                            <a href="{{ route('link-contents.index', ['type' => $type, 'id' => $model->id]) }}" class="btn btn-sm btn-primary">
                    ...
                    {{-- Form --}}
                    <form action="{{ route('link-contents.update', ['type' => $type, 'id' => $model->id, 'linkContent' => $linkContent->id]) }}" 
                          method="POST" 
                        ...
                        <div class="card-footer bg-transparent mt-4">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if($type == 'link')
                                    <a href="{{ route('links.show', $model) }}" class="btn btn-link">
                                        Cancel
                                    </a>
                                @else
                                    <a href="{{ route('link-contents.index', ['type' => $type, 'id' => $model->id]) }}" class="btn btn-link">
                                        Cancel
                                    </a>
                                @endif
                            </div>
