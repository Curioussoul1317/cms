            ...
            <div class="card">
                <div class="card-body">
                    @if($template)
                        ...
                        <form action="{{ route('link-contents.store', ['type' => $type, 'id' => $model->id]) }}" 
                              method="POST" 
                            ...
                            <div class="card-footer bg-transparent mt-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('link-contents.index', ['type' => $type, 'id' => $model->id]) }}" 
                                       class="btn btn-link">
                                        Cancel
                                    </a>
                                </div>
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3">
                                @foreach($templates as $key => $tmpl)
                                    <div class="col">
                                        <a href="{{ route('link-contents.create', ['type' => $type, 'id' => $model->id, 'template' => $key]) }}" 
