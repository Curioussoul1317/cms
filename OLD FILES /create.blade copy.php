...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Link: <span class="font-semibold">{{ $link->name }}</span></p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            @if($template)
                ...
                <form action="{{ route('link-contents.store', $link) }}" 
                      method="POST" 
                    ...
                    <div class="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('link-contents.create', $link) }}" 
                ...
                <div class="text-center py-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach($templates as $key => $tmpl)
                            <a href="{{ route('link-contents.create', ['link' => $link, 'template' => $key]) }}" 
