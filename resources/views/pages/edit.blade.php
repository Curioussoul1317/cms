    ...
    <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <div class="text-muted mt-1">Editing: <strong>{{ $page->name }}</strong></div>
            </div>
                                            ...
                                            <select name="main_category_id" 
                                                ...
                                                @foreach($mainCategories as $category)
                                                    <option value="{{ $category->id }}" 
                                                            {{ old('main_category_id', $page->main_category_id) == $category->id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" 
                                                      ...
                                                      placeholder="Enter a brief description of this page">{{ old('description', $page->description) }}</textarea>
...
@else
               @if($page->svg)
                                ...
                                <div class="mb-3">
                                    <label class="form-label">{{ $page->svg ? 'Replace' : 'Upload' }} SVG Icon</label>
                                    <input type="file" 
                                           name="svg" 
                                           id="svg" 
                            ...
                            @if($page->children()->count() > 0)
                                <div class="alert alert-warning mt-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="alert-title">This page has {{ $page->children()->count() }} child page(s)</h4>
                                            <div class="text-muted">
                                                Ensure "Allow Child Pages" remains enabled, or move child pages elsewhere before disabling.
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    // Auto-fill heading from name (only if heading is empty)
