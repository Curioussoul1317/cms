    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Media Categories</h2>
            </div>
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    ...
                    <a href="{{ route('mediafiles.index') }}" class="btn btn-outline-primary d-none d-sm-inline-block">
                        <i class="ti ti-files me-1"></i>
                        Manage Files
                    </a>
                    <a href="{{ route('mediacategories.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        <i class="ti ti-plus me-1"></i>
                        Add Category
                    </a>
                    {{-- Mobile button --}}
                    <a href="{{ route('mediacategories.create') }}" class="btn btn-primary d-sm-none btn-icon" aria-label="Add Category">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-cyan-lt">
                                            ...
                                            {{ $category->media_files_count }} {{ Str::plural('file', $category->media_files_count) }}
                                        </span>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            <a href="{{ route('mediacategories.edit', $category) }}" 
                                               class="btn btn-icon btn-ghost-warning" 
                                               data-bs-toggle="tooltip" 
                                               title="Edit Category">
                                                <i class="ti ti-edit"></i>
                                            </a>
                                            <form action="{{ route('mediacategories.destroy', $category) }}" 
                                                  method="POST" 
                                                  class="d-inline"
                                                ...
                                                <button type="submit" 
                                                        ...
                                                        {{ $category->media_files_count > 0 ? 'disabled' : '' }}>
                ...
                <div class="card-body">
                    <div class="empty">
                        ...
                        <p class="empty-subtitle text-secondary">
                            Create categories to organize your media files.
                        </p>
