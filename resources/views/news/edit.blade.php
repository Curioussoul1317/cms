...
<div class="page-body">
    ...
    @if(!$news->is_approved)
        ...
        <form action="{{ route('approve', ['model' => 'news', 'id' => $news->id]) }}" method="POST" class="d-inline">
            @csrf
            @method('PATCH')
    ...
    @else
        ...
        <form action="{{ route('unapprove', ['model' => 'news', 'id' => $news->id]) }}" method="POST" class="d-inline">
            @csrf
            @method('PATCH')
...
@if($news->is_approved)
    @if(!$news->is_published)
        ...
        <form action="{{ route('publish', ['model' => 'news', 'id' => $news->id]) }}" method="POST" class="d-inline">
            @csrf
            @method('PATCH')
    ...
    @else
        ...
        <form action="{{ route('unpublish', ['model' => 'news', 'id' => $news->id]) }}" method="POST" class="d-inline">
            @csrf
            @method('PATCH')
