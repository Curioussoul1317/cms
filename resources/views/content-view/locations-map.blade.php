        ...
        <div class="" style="padding: 0px;">
            ...
            <style>
                ...
                .location-btn.active {
                    ...
                    border-color: var(--primary-color);
                    color: #ffffff;
                    box-shadow: 0 4px 15px rgba(28, 234, 185, 0.3);
                }
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (mapToggleBtn) {
                        mapToggleBtn.addEventListener('click', function() {
                            ...
                            if (mapSection.classList.contains('show')) {
                                mapToggleText.textContent = 'Hide Map';
                                mapToggleBtn.querySelector('i').className = 'fa-solid fa-xmark';
                            } else {
                                mapToggleText.textContent = 'Show Map';
                                mapToggleBtn.querySelector('i').className = 'fa-solid fa-map';
                            }
                        });
                    }
