    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('admin.locations.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        <i class="ti ti-plus me-1"></i>
                        Add Location
                    </a>
                    {{-- Mobile button --}}
                    <a href="{{ route('admin.locations.create') }}" class="btn btn-primary d-sm-none btn-icon" aria-label="Add Location">
