    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('locations.index') }}" class="btn btn-outline-secondary d-none d-sm-inline-block">
                    ...
                    <a href="{{ route('places.create') }}" class="btn btn-primary d-sm-none btn-icon" aria-label="Add Place">
                        ...
                        <tbody>
                            @foreach($places as $place)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('locations.show', $place->location) }}" class="text-decoration-none">
