    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Create Download Category</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="page-body">
    <div class="container-xl">
        ...
        <form action="{{ route('downloadcategories.store') }}" method="POST">
            @csrf
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex mb-3">
                                ...
                                <div>
                                    <h4 class="mb-1">Organize Downloads</h4>
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-secondary small mb-0">Use descriptive names for better user experience.</p>
                                </div>
                            </div>
                        </div>
                    </div>
