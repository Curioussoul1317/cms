    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('hero-sections.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        <i class="ti ti-plus me-1"></i>
                        Add Hero Section
                    </a>
                    {{-- Mobile button --}}
                    <a href="{{ route('hero-sections.create') }}" class="btn btn-primary d-sm-none btn-icon" aria-label="Add Hero Section">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            <a href="{{ route('hero-sections.edit', $hero) }}" 
                                               class="btn btn-icon btn-ghost-warning" 
                                               data-bs-toggle="tooltip" 
                                               title="Edit Hero">
                                                <i class="ti ti-edit"></i>
                                            </a>
                                            <form action="{{ route('hero-sections.destroy', $hero) }}" 
                                                  method="POST" 
                                                  class="d-inline"
                ...
                <div class="card-body">
                    <div class="empty">
                        ...
                        <p class="empty-subtitle text-secondary">
                            Create hero sections to display on different pages of  website.
                        </p>
