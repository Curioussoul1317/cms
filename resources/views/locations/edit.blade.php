        ...
        <div class="row g-2 align-items-center">
            <div class="col">
                <div class="page-pretitle">
                    <a href="{{ route('locations.index') }}" class="text-secondary text-decoration-none">
                        ...
                        <div class="card-body">
                            ...
                            <div class="map-selector-container mt-4">
                                ...
                                <div class="map-wrapper">
                                    @include('locations.partials.map-svg')
                                </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            @if(($location->places_count ?? 0) > 0)
                                <a href="{{ route('places.index', ['location' => $location->id]) }}" class="btn btn-outline-primary btn-sm w-100">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <a href="{{ route('locations.show', $location) }}" class="btn btn-outline-primary">
                                    <i class="ti ti-eye me-1"></i>
                                    View Location
                                </a>
