                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-actions">
                            <a href="{{ route('places.create') }}?location_id={{ $location->id }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="card-body">
                            <div class="empty">
                                ...
                                <div class="empty-action">
                                    <a href="{{ route('places.create') }}?location_id={{ $location->id }}" class="btn btn-primary">
                                        <i class="ti ti-plus me-1"></i>
                                        Add First Place
                                    </a>
                                </div>
